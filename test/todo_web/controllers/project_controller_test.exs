defmodule TodoWeb.ProjectControllerTest do
  use TodoWeb.ConnCase

  import Todo.ProjectsFixtures

  @create_attrs %{discription: "some discription", title: "some title"}
  ...
  describe "update project" do
    ...
    test "redirects when data is valid", %{conn: conn, project: project} do
      ...
      assert html_response(conn, 200) =~ "some updated discription"
    end
